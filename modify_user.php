...
?>
<div class="message">The user has been successfuly been updated. You need to log again.<br />
...
<div class="content">
    <form action="modify_user.php" method="post">
        ...
        <div class="center">
            ...
            <label for="password">Password<span class="small"></span></label><input type="password" name="password" id="password" value="<?php echo $password; ?>" /><br />
            <label for="passverif">Password<span class="small"></span></label><input type="password" name="passverif" id="passverif" value="<?php echo $password; ?>" /><br />
